...
===================================================================
--- git.orig/arch/arm/Kconfig	2017-09-18 12:14:41.998113674 +0200
+++ git/arch/arm/Kconfig	2017-09-18 12:14:42.502113664 +0200
@@ -396,6 +396,9 @@
...
+source "board/freescale/mx6dlroj/Kconfig"
 source "board/freescale/mx6qsabreauto/Kconfig"
 source "board/freescale/mx6sabresd/Kconfig"
 source "board/freescale/mx6slevk/Kconfig"
Index: git/board/freescale/mx6dlroj/Kconfig
===================================================================
--- /dev/null	1970-01-01 00:00:00.000000000 +0000
+++ git/board/freescale/mx6dlroj/Kconfig	2017-09-18 12:14:42.502113664 +0200
@@ -0,0 +1,18 @@
+if TARGET_MX6DLROJ
+
+config SYS_CPU
...
+
+endif
Index: git/board/freescale/mx6dlroj/MAINTAINERS
===================================================================
--- /dev/null	1970-01-01 00:00:00.000000000 +0000
+++ git/board/freescale/mx6dlroj/MAINTAINERS	2017-09-18 12:14:42.502113664 +0200
@@ -0,0 +1,7 @@
+MX6SROJ BOARD
+M:	Dario Pennisi <dario@iptronix.com>
+S:	Maintained
+F:	board/freescale/mx6dlsroj/
+F:	include/configs/mx6dlroj.h
+F:	configs/mx6dlroj_defconfig
+F:	configs/mx6qroj_defconfig
Index: git/board/freescale/mx6dlroj/Makefile
===================================================================
--- /dev/null	1970-01-01 00:00:00.000000000 +0000
+++ git/board/freescale/mx6dlroj/Makefile	2017-09-18 12:14:42.502113664 +0200
@@ -0,0 +1,9 @@
+#
...
+
+obj-y  := mx6dlroj.o
Index: git/board/freescale/mx6dlroj/imximage.cfg
===================================================================
--- /dev/null	1970-01-01 00:00:00.000000000 +0000
+++ git/board/freescale/mx6dlroj/imximage.cfg	2017-04-12 14:39:28.000000000 +0200
@@ -0,0 +1,131 @@
+/*
...
Index: git/board/freescale/mx6dlroj/mx6dl.cfg
===================================================================
--- /dev/null	1970-01-01 00:00:00.000000000 +0000
+++ git/board/freescale/mx6dlroj/mx6dl.cfg	2017-09-18 12:14:42.502113664 +0200
@@ -0,0 +1,119 @@
+/*
...
+DATA 4 0x020e0018 0x007F007F
+DATA 4 0x020e001c 0x007F007F
Index: git/board/freescale/mx6dlroj/mx6dlroj.c
===================================================================
--- /dev/null	1970-01-01 00:00:00.000000000 +0000
+++ git/board/freescale/mx6dlroj/mx6dlroj.c	2017-09-18 12:14:42.502113664 +0200
@@ -0,0 +1,736 @@
+/*
...
+}
+
+static unsigned char usb_init_blob_2port[] = {
+	0x11,	//data size
+	0x24,	//VID LSB
+	0x04,	//VID_MSB
+	0x12,	//PID LSB
...
+	0x32	//PWRT
+};
+static unsigned char usb_init_blob2_2port[] = {
+	0x01,
+	0x01
+};
+
...
+
+	/* 2 port onboard USB HUB initialization */
+	I2C_SET_BUS(2);
...
+	}
+
+	printf("Board: MX6DL-Roj rev%s\n", revname);
+
+	return 0;
+}
Index: git/configs/mx6dlroj_defconfig
===================================================================
--- /dev/null	1970-01-01 00:00:00.000000000 +0000
+++ git/configs/mx6dlroj_defconfig	2017-09-18 12:14:42.502113664 +0200
@@ -0,0 +1,3 @@
+CONFIG_SYS_EXTRA_OPTIONS="IMX_CONFIG=board/freescale/mx6dlroj/imximage.cfg,MX6DL"
+CONFIG_ARM=y
+CONFIG_TARGET_MX6DLROJ=y
Index: git/include/configs/mx6dlroj.h
===================================================================
--- /dev/null	1970-01-01 00:00:00.000000000 +0000
+++ git/include/configs/mx6dlroj.h	2017-09-18 12:14:42.502113664 +0200
@@ -0,0 +1,55 @@
+/*
+ * Copyright (C) 2012 Freescale Semiconductor, Inc.
+ *
+ * Configuration settings for the ROJ i.MX6DL board.
+ *
+ * SPDX-License-Identifier:	GPL-2.0+
+ */
+
+#ifndef __MX6DLROJ_CONFIG_H
+#define __MX6DLROJ_CONFIG_H
+
...
+
+#endif                         /* __MX6DLROJ_CONFIG_H */
Index: git/include/configs/mx6roj_common.h
===================================================================
--- /dev/null	1970-01-01 00:00:00.000000000 +0000
+++ git/include/configs/mx6roj_common.h	2017-09-18 12:14:42.502113664 +0200
@@ -0,0 +1,295 @@
+/*
+ * Copyright (C) 2012 Freescale Semiconductor, Inc.
+ *
...
+ */
+
+#ifndef __MX6DLROJ_COMMON_CONFIG_H
+#define __MX6DLROJ_COMMON_CONFIG_H
+
+#define CONFIG_MX6
+
...
+	"video_args=video=mxcfb0:dev=ldb,1920x1080M-32@30,if=LVDS888,bpp=32\0" \
...
+
+#endif                         /* __MX6DLROJ_COMMON_CONFIG_H */
